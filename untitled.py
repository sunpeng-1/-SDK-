...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(775, 577)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(170, 30, 401, 131))
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(260, 200, 181, 31))
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(90, 440, 201, 61))
        self.pushButton_8.setObjectName("pushButton_8")

        self.pushButton_9 = QtWidgets.QPushButton(Dialog)
        self.pushButton_9.setGeometry(QtCore.QRect(430, 440, 201, 61))
        self.pushButton_9.setObjectName("pushButton_9")

        self.lineEdit_2 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_2.setGeometry(QtCore.QRect(260, 280, 181, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "学生课堂人脸识别签到系统"))
        self.pushButton_2.setText(_translate("Dialog", "普通成员登录"))
        self.pushButton_4.setText(_translate("Dialog", "管理员登录"))

        self.pushButton_8.setText(_translate("Dialog", "查询签到时间"))

        self.pushButton_9.setText(_translate("Dialog", "查询签到名单"))
        ...
        Dialog.setWindowTitle("学生课堂人脸识别签到")  # 设置标题
        ...
        self.pushButton_8.setStyleSheet('''QPushButton{font-size:25px;}
                        QPushButton:hover{color:black;border:0px solid #F3F3F5;
                                                border-radius:10px;
                                                background:LightGray;} ''')

        self.pushButton_9.setStyleSheet('''QPushButton{font-size:25px;}
                                QPushButton:hover{color:black;border:0px solid #F3F3F5;
                                                        border-radius:10px;
                                                        background:LightGray;} ''')
